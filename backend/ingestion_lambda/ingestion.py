...
def ingestion_lambda_handler(event, context):
    ...
    best_ticker, best_pct_change, best_close = find_best_mover(WATCHLIST, trade_date, api_key)
    ...
    logger.info("Wrote best mover: %s %s %.4f%% close=%.2f", trade_date, best_ticker, best_pct_change, best_close)
